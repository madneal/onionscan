...
[![Build Status](https://travis-ci.org/s-rah/onionscan.svg?branch=onionscan-0.2)](https://travis-ci.org/s-rah/onionscan) [![Go Report Card](https://goreportcard.com/badge/github.com/neal1991/onionscan)](https://goreportcard.com/report/github.com/neal1991/onionscan)
...
See <a href="https://github.com/neal1991/onionscan/wiki">the wiki</a> for guidance.

### Grab with go get

`go get github.com/neal1991/onionscan`

### Compile/Run from git cloned source

Once you have cloned the repository into somewhere that go can find it you can
run `go install github.com/neal1991/onionscan` and then run the binary in `$GOPATH/bin/onionscan`.

Alternatively, you can just do `go run github.com/neal1991/onionscan.go` to run without compiling.
